...
<header class="main-header">
    ...
    <a href="" class="logo">
      ...
      <span class="logo-mini"><b>ENDE</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Sistema ENDE</b></span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="{{asset("assets/$theme/dist/img/user.png")}}" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Support Team
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{asset("assets/$theme/dist/img/user.png")}}" class="user-image" alt="User Image">
